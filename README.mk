...
Exercício 2: A) Copiei os ficheiros do caminho "ETC" para o caminho "VAR/BARCKUPS"
B)Configurei o serviço Cron para fazer backup a cada 30 min (*/10 * * * * /bin/sh backup.sh)
